...
// }
grails.config.locations = ["file:${userHome}/barber/${appName}-config.groovy"]
...
grails.plugin.springsecurity.interceptUrlMap = [
        ...
        '/userRest/**'          : ["ROLE_ADMIN", "ROLE_USER"],
        '/serviceRest/**'       : ["ROLE_ADMIN", "ROLE_USER"],
        '/ticketRest/**'        : ["ROLE_ADMIN", "ROLE_USER"],
        '/worktimeRest/**'      : ["ROLE_ADMIN", "ROLE_USER"],
        '/businessRest/**'      : ["ROLE_ADMIN", "ROLE_USER"],
        '/service/**'           : ["ROLE_ADMIN", "ROLE_USER"],
        '/serviceGroup/**'      : ["ROLE_ADMIN", "ROLE_USER"],
        '/serviceGroupRest/**'  : ["ROLE_ADMIN", "ROLE_USER"],
